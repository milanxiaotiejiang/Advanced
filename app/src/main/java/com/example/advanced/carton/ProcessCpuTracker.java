...
public class ProcessCpuTracker {
    ...
    public void update() {
        ...
        if (sysCpu != null) {
            ...
            if (DEBUG) {
                Logger.i(TAG, "Total U:" + (usertime)
                        + " S:" + (systemtime) + " I:" + (idletime)
                        + " W:" + (iowaittime) + " Q:" + (irqtime)
                        + " O:" + (softirqtime));
                Logger.i(TAG, "Rel U:" + mRelUserTime + " S:" + mRelSystemTime
        ...
        if (DEBUG) {
            Logger.i("*** TIME TO COLLECT STATS: "
    ...
    private void collectProcsStats(String procFile, Stats st) {
        ...
        if (DEBUG) {
            Logger.v("Stats changed " + st.name + " status:" + status + " pid=" + st.pid
    ...
    final public String printCurrentState(long now) {
        ...
        if (DEBUG) {
            Logger.i("totalTime " + totalTime + " over sample time "
